"""
Django settings for green_dawn_dev_60375 project.
...
ROOT_URLCONF = 'green_dawn_dev_60375.urls'
...
WSGI_APPLICATION = 'green_dawn_dev_60375.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_dawn_dev_60375 API",
    "DESCRIPTION": "API documentation for green_dawn_dev_60375 App",
    "VERSION": "v1",
}
